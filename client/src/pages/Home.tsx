        ...
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 animate-fade-in-delay">
              Discover, share, and celebrate amazing animations from creators around the world
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <p className="text-gray-600">
              Explore a vast library of creative animations from talented artists worldwide
            </p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <p className="text-gray-600">
              Like, comment, and share videos. Connect with creators and fellow enthusiasts
            </p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <p className="text-gray-600">
              Bookmark your favorite videos and build your personal collection
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-100 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join our community and start exploring amazing animations today
          </p>
          <Link
            to="/community"
